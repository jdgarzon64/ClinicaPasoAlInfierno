...
namespace ClinicaPasoAlInfierno.Controllers
{
    public class CitasController : Controller
    {
        ...
        public ActionResult Create()
        {
            ...
            ViewBag.idEnfermedad = new SelectList(db.Enfermedades, "idEnfermedad", "descripcion");
        ...
        public ActionResult Create([Bind(Include = "idCita,idMedico,idPaciente,idEnfermedad")] Citas citas)
        {
            ...
            ViewBag.idEnfermedad = new SelectList(db.Enfermedades, "idEnfermedad", "descripcion", citas.idEnfermedad);
