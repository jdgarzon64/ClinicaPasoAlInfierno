...
namespace ClinicaPasoAlInfierno.Controllers
{
    public class EnfermedadesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "idEnfermedad,descripcion")] Enfermedades enfermedades)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "idEnfermedad,descripcion")] Enfermedades enfermedades)
        {
            if (ModelState.IsValid)
            {
